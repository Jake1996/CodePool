...
/**
 * Given an integer n, how many ways can K non-negative integers less than or
 * equal to n add up to n?
 * 
 * @author jatin Input : The Sum followed by how many ways it is supposed to be
 *         split into Output: The total no of ways the sum can be obtained by
 *         adding the required number of numbers
 */
public class UVA10943 {
	 ...
	 * @return the total ways in which the sum can be obtained by adding noOfNo
	 *         numbers
	 */
